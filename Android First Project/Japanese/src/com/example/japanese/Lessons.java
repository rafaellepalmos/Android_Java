...
public class Lessons extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Button introductory = (Button) findViewById(R.id.introductory);
		introductory.setOnClickListener(new View.OnClickListener() {
		...
		greetings.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				startActivity(new Intent("android.intent.action.GREETINGS"));
